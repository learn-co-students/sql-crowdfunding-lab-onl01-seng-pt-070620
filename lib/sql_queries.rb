...
def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal
  # we need how much over the project goal that someone has raised
  # only projects that have met or exceeded their project goal
...
def selects_user_names_and_amounts_of_all_pledges_grouped_by_name_then_orders_them_by_the_summed_amount
  # Select the user's name and the pledge amount
  # group them by user's name
  # order the pledge amount
...
def selects_the_category_names_and_pledge_amounts_of_all_pledges_in_the_music_category
  # select category name along with amount of pledges for that category
  # group by category name
  # list all of the pledges of that category
...
def selects_the_category_name_and_the_sum_total_of_the_all_its_pledges_for_the_books_category
  # return the category name of book and sum of all of the pledges of the 'books' category
